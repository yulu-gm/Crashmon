...
先以[首次体验工作稿](docs/game-design/first-session.md)细化初始伙伴、首次捕捉和双宠协作，再确定最小战斗规则。现阶段先完成体验，暂缓题材与画风；数量与节奏目标待试玩验证。

工程上仍先验证注册、登录、初始资产只领取一次、退出重进与重启恢复，再接入战斗和活动。这些不是要求玩家执行的新手任务；也不能把独立账号登录视为已经实现合作玩法。
